import { GridLine, VerticalGreenGridBar } from "../common/page-grid";
      ...
      <ChildDiv className="p-0 md:p-6 xl:p-6 bg-primary grow">
        ...
        >
          ...
          <BtnPrimary
            ...
            className="w-full justify-between md:w-fit gap-1.25 bg-green-light-a border-green-light-b hover:bg-green-a active:bg-green-a hover:border-green-a active:border-green-a text-primary stroke-primary "
          />
        </div>
      </ChildDiv>
